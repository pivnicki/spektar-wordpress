...
function spektrum_enqueue(){
    ...
    // wp_register_script( 'jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js', array(), false, false );
	...
	wp_register_script('spektrum_collapse.js','http://twitter.github.io/bootstrap/assets/js/bootstrap-collapse.js',array(),false,false);
	...
	wp_enqueue_script('spektrum_collapse.js');
